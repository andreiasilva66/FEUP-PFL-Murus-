...
print_player_menu :-
    ...
    print('================================================'), nl,
    print('|                                              |'), nl,
    print('|               1 - Romans - X and v           |'), nl,
    print('|               2 - Gauls - 8 and o            |'), nl,
    print('|                                              |'), nl,
    print('================================================'), nl.
...
print_instructions :-
    ...
    print('|  Player 2 has 8 pieces.                                      |'), nl,
    print('|  There are two types of pieces: Towers,  as stacks of two    |'), nl,
    print('|  stones represented in X and 8, and Walls, single stones     |'), nl,
    print('|  represented in v and o.                                     |'), nl,
    print('|                                                              |'), nl,
